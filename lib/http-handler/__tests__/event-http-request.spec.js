...
const { EventHttpRequest } = require('../../http-handler');
...
describe('EventHttpRequest', () => {
  ...
  test('deve inicializar a partir de um evento do ALB com body json', async () => {
    ...
    expect(request.url).toEqual('/v2/fiscal/nfes/lote/emissao?id=bbcb3e49-b3a6-47e4-bc7d-bf4f5313ea9a');
    ...
    expect(request.getHeader('x-api-key')).toEqual('UGOc3L8CrXK22OC5XuYisQ==:1b2c46ca-fe64-4679-a0b6-c615e394b618');
