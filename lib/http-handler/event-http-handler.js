...
module.exports = class EventHttpHandler extends EventEmitter {
    ...
    try {
      ...
      const middlewares = this.middlewares
        ...
        .map((middleware) => middleware({
          request, router, route: matched, context,
        }));
  ...
  async flush() {
    Object.keys(this.context).forEach((key) => {
      ...
      if (typeof object === 'object' && 'flush' in object && typeof object.flush === 'function') {
        object.flush();
      }
    });
  }
